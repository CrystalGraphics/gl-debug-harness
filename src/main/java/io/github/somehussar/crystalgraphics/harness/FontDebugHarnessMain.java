...
//            System.load("C:\\Program Files\\RenderDoc\\renderdoc.dll");
        ...
        try {
            ...
            // The cursor is CrystalGUI's, not the backend's, so it installs separately. LWJGL2 has no
            // standard cursors, which is what Lwjgl2CursorService draws from CursorBitmaps for.
    ...
    private static void printHelp(SceneRegistry registry) {
        ...
        System.out.println("  --msdf-atlas-scale=<n>           MSDF atlas generation scale in px/EM (default: 64)");
        System.out.println("  --msdf-px-range=<f>              MSDF pixel range (default: 2.0)");
        ...
        System.out.println("  --msdf-error-correction-mode=<n>            Error correction mode integer (default: 2)");
        System.out.println("  --msdf-distance-check-mode=<n>              Distance check mode integer (default: 1)");
        ...
        System.out.println("  --msdf-spacing-px=<n>                       Atlas spacing in pixels (default: 0)");
        ...
        System.out.println("  --msdf-edge-coloring-mode=<simple|ink_trap|distance>  Edge coloring strategy (default: ink_trap)");
